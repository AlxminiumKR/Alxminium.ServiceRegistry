...
INSERT INTO `requests` VALUES (1,'admin','Участок №1',1,'Офис Центр','Ремонт принтера','Техническое обслуживание',7,'шт.',0.00,12,0.00,'В работе','dawdaw','2026-03-31 15:41:25'),(2,'admin','Участок №1',1,'Офис Центр','Ремонт принтера','Техническое обслуживание',7,'шт.',0.00,12,0.00,'Выполнена','test','2026-03-31 15:45:30'),(3,'admin','Участок №1',1,'Офис Центр','Ремонт принтера','Техническое обслуживание',7,'шт.',0.00,123,0.00,'Выполнена','etst','2026-03-31 18:00:27'),(5,'user1','Участок №1',1,'Офис Центр','Ремонт принтера','Техническое обслуживание',7,'шт.',0.00,2,0.00,'В работе','user','2026-04-01 05:46:44'),(6,'admin','Участок №1',1,'Офис Центр','Ремонт принтера','Техническое обслуживание',7,'шт.',0.00,23,0.00,'Выполнена','testtt test','2026-04-01 06:17:40'),(7,'admin','Участок №1',2,'ЖЭУ-01','Разработка прикладного ПО','Разработка ПО',7,'шт.',1500.00,3,4500.00,'Выполнена','test','2026-04-03 05:46:12');
...
-- Dump completed on 2026-04-03  6:43:01
